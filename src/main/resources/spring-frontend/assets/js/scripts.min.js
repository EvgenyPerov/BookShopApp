                            ...
                            postData('/approveContact', data, function (result) {
                                if (result.result) {
                                    ...
                                    if (result) {
                                        ...
                                        let infoFinishTry = 'Число попыток подтверждения превышено. Через 5 миеут повторите попытку, нажав "Подтвердить" для получения нового кода';
                                        ...
                                        $row.find('.form-input_code').addClass('form-input_error').after('<div class="form-error">' + 'Неверный код или срок ожидания превышен' + message + '</div>');
                                    } else {
                            ...
                            postData('/approveContactProfile', data, function (result) {
                                if (result.result) {
                                    ...
                                    if (result) {
                                        ...
                                        $this.val('');
                                        $but.prop('disabled', false);
                                        $row.find('.form-input_code_profile').addClass('form-input_error').after('<div class="form-error">' + 'Wrong phone' + '</div>');
                                    } else {
                                        $this.addClass('form-input_error').after('<div class="form-error">' + result.error + '</div>');
                                    }
                                }
