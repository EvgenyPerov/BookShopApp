                            ...
                            postData('/approveContact', data, function (result) {
                                if (result.result) {
                                    ...
                                    if (result) {
                                        ...
                                        $row.find('.form-input_code').addClass('form-input_error').after('<div class="form-error">' + 'Wrong email or phone' + '</div>');
                                    } else {
                                ...
                                postData('/login', $this.data('send'), function (result) {
                                    if (result != null && result.result) {
                                        ...
                                        if (result) {
                                            ...
                                            $thisStep.find('.form-input:not(.form-input_hide)[type="text"]').addClass('form-input_error').after('<div class="form-error">' + 'Пользователь не найден или не верный логин\/пароль или Токен недействителен' + '</div>');
                                        }
                                    }
                                })
                            } else {
